  ...
  <div class="zhsq-main" ref="innerBody">
    <div class="index">
      <el-amap ref="map" :center="center" :zoom="zoom">
        <el-amap-info-window  :position="center" :content="content"  :offset="[0,-15]" showShadow :visible="windowVisible"></el-amap-info-window>
        <el-amap-marker vid="marker" :position="center" :icon="houseIcon" :events="events" ></el-amap-marker>
      </el-amap>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted(){
    this._height();
    //this.center=[104.067923463,30.6799428454]
  ...
  methods: {
    ...
    initWebSocket(){
      ...
      const on_connect = ()=> {
        client.subscribe(`/exchange/TopicExchangeFontAYIC/topic.open.door.front.record${this.organPath}`, (frame)=> {
