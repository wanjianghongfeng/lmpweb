              ...
              <el-table :data="tableData" style="width: 100%" stripe :height='tabHeight' :max-height="tabHeight">
                ...
                <el-table-column label="操作" align='center' width="220">
                  <template slot-scope="scope">
                    ...
                    <el-button type="primary" size="mini" @click="authorization(scope.row)">授权</el-button>
                    <el-button type="primary" size="mini" @click="resetPwd(scope.row)">重置</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      resetPwd(row){
        this.$confirm(`确定重置账号密码吗？`, '提示', {
          type: 'warning'
        }).then(async () => {
          const data = await Api.resetUserPwd.put({}, {
            pathParams: {
              id: row.id
            }
          }).then(res => {
